...
import stackImage from '../assets/about/meraj-avatar.png';
...
const ReactIcon = () => (
  <div className="flex flex-col items-center gap-2">
    <svg className="w-16 h-16 md:w-20 md:h-20" viewBox="0 0 128 128" fill="none">
      ...
      {/* React Logo */}
      <g stroke="#61DAFB" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" transform="translate(64, 55)">
        <circle cx="0" cy="0" r="7" fill="#61DAFB" />
        <ellipse rx="38" ry="14" />
        <ellipse rx="38" ry="14" transform="rotate(60)" />
        <ellipse rx="38" ry="14" transform="rotate(120)" />
      </g>
      <text x="64" y="112" fill="#FFFFFF" fontSize="13" fontFamily="sans-serif" fontWeight="900" textAnchor="middle">React</text>
    </svg>
...
const JavaScriptIcon = () => (
  <div className="flex flex-col items-center gap-2">
    <svg className="w-16 h-16 md:w-20 md:h-20" viewBox="0 0 128 128" fill="none">
      <rect width="128" height="128" rx="24" fill="#1E293B" />
      <rect x="34" y="22" width="60" height="60" rx="8" fill="#F7DF1E" />
      <text x="76" y="73" fill="#000000" fontSize="36" fontFamily="sans-serif" fontWeight="900" textAnchor="middle">JS</text>
      <text x="64" y="112" fill="#FFFFFF" fontSize="13" fontFamily="sans-serif" fontWeight="900" textAnchor="middle">JavaScript</text>
    </svg>
...
const About = () => {
  return (
    <section id="about" className="bg-[#c1b1a1] pt-20 pb-40 px-6 md:px-12 w-full relative overflow-hidden font-sans">
